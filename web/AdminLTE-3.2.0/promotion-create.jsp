    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <title>Tạo Chiến Dịch Khuyến Mãi Mới</title>
                                                ...
                                                <div class="section-block">
                                                    ...
                                                    <div class="section-block">
                                                        ...
                                                        <input type="text" class="form-control promo-input"
                                                            ...
                                                            placeholder="VD: Khuyến mãi Tết Nguyên Đán" required>
                                                    ...
                                                    <div class="section-block">
                                                        ...
                                                        <select class="form-control promo-select" id="promotionType"
                                                            ...
                                                            required>
                                                            <option value="PERCENT" selected>Giảm % Giá</option>
                                                    ...
                                                    <div class="section-block">
                                                        ...
                                                        <div class="custom-control custom-switch mt-1">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="promoStatus" name="status" value="ACTIVE" checked>
                                                ...
                                                <div class="section-block">
                                                    ...
                                                    <div class="condition-row">
                                                        <label class="check-label" for="chkApplyCategory">
                                                            <input type="checkbox" id="chkApplyCategory"
                                                                name="applyCategory" value="true" checked
                                                    ...
                                                    <div class="condition-row">
                                                        ...
                                                        <select class="form-control promo-select" id="tierSelect"
                                                            name="customerTier" style="width: 140px;" disabled>
