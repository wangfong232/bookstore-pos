...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .invoice-filters-card .card-header {
                                            ...
                                            <tbody>
                                                <c:forEach var="inv" items="${invoices}" varStatus="st">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <fmt:formatDate value="${inv.paidAt}"
                                                        ...
                                                        <td>${inv.staffName}</td>
                                                        <td class="text-right">
                                                            <fmt:formatNumber value="${inv.totalAmount}"
                                                                              type="number"
                                                                              maxFractionDigits="0"/> đ
                                                        </td>
                                                        <td class="text-right">
                                                            <fmt:formatNumber value="${inv.discountAmount}"
                                                                              type="number"
                                                                              maxFractionDigits="0"/> đ
                                                        </td>
                                                        ...
                                                        <td>
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${inv.paymentStatus == 'PENDING'}">
                                                                    <span class="invoice-status-badge invoice-status-pending">
                                                                        Chờ thanh toán
                                                                    </span>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <span class="invoice-status-badge invoice-status-cancelled">
                                                                        Đã hủy
                                                                    </span>
                                                                </c:otherwise>
                                                            </c:choose>
                                ...
                                <c:if test="${empty invoices}">
                                    <div class="invoice-empty-state">
                                        ...
                                        <p class="text-muted mb-0">
                                            Hãy thực hiện giao dịch tại màn hình POS, sau đó quay lại đây để xem lịch sử hóa đơn.
                                        </p>
                                    </div>
                                </c:if>
                            </div>
